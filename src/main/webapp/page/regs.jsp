...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>安居客租房 - 用户注册</TITLE>
 ...
 <script type="text/javascript" src="/admin/js/jquery-1.8.3.js"></script>
  <script type="text/javascript">
      $(function () {  //加载事件
          ...
          $("#but1").click(function () {
              //发请求到服务器验证用户名是否存在
              $.post("checkUsername",{"username":$("#name").val()},function (data) {
                  if (data.result==0){
...
<TABLE class=field>
  ...
  <TR>
    ...
    <TD><INPUT class=text type=text name=name id="name"> <span id="notice"></span>
      <input type="button" value="检查用户名是否存在" id="but1"/>
    </TD></TR>
  <TR>
