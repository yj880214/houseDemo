            ...
            $("#streetDg").datagrid({
                ...
                columns:[[
                    ...
                    {field:'opt',title:'操作',width:50,align:"center",
                        formatter: function(value,row,index){
                            // return "<a href='deleteDistrict?id="+row.id+"'>删除</a>";
                            return "<a href='javascript:delSingle("+row.id+")'>删除</a>  | <a href='javascript:openStreetDialog("+row.id+")'>查看详情</a>";
                        }
                    }
                ]]
            });
...
<%--添加信息的对话框显示--%>
  ...
  <div id="streetDialog" class="easyui-dialog" buttons="#upDialogButtons"
      ...
      <br/>
      <form action="${pageContext.request.contextPath}/admin/insertStreet" method="post">
          区域编号：<input type="text" id="distrctId" name="districtId" />
